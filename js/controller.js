...
function selectRed()
{
  ...
  selectBlueButton.style.background = '#EB6123';
  turn = 1;
  playerNumber = 1;
  AIPlayerNumber = 2;
...
function selectBlue()
{
  ...
  selectRedButton.style.background = '#EB6123';
  turn = 1;
  playerNumber = 2;
  AIPlayerNumber = 1;
...
function select1()
{
  ...
  select2Btn.style.background = '#EB6123';
  select3Btn.style.background = '#EB6123';
}
...
function select2()
{
  ...
  select1Btn.style.background = '#EB6123';
  select3Btn.style.background = '#EB6123';
}
...
function checkBlueWin(board)
{
  ...
  {
    gameOver = true;
    playerTurn.innerHTML = "Orange Wins!"
    drawBoard();
    return true;
  }
  return false;
...
function updateTurn()
{
  if (turn == 1)
  {
    playerTurn.innerHTML = 'Orange\'s move!';
    turn = 2;
  }
  else
  {
